...
export default function Wallet(props) {
  ...
  if (qr) {
    ...
    const metaPrivateKey = localStorage.getItem("metaPrivateKey");
    const wallet = new ethers.Wallet(metaPrivateKey);
    ...
    if (wallet.address !== selectedAddress) {
      ...
      display = (
        <div>
          ...
          <div>
            <Text copyable>{metaPrivateKey}</Text>
          </div>
          ...
          <i>
            ...
            <a target="_blank" href={"https://xdai.io/" + metaPrivateKey} rel="noopener noreferrer">
              burner wallet
            </a>
            :
          </i>
          <QR
            value={"https://xdai.io/" + metaPrivateKey}
            size="450"
            level="H"
            includeMargin
            renderAs="svg"
