...
const headerWithTopBar = {
  ...header,
  height: `calc(${header.height} + ${topBar.height})`,
  heightXl: `calc(${header.heightXl} + ${topBar.heightXl})`,
  heightXXl: `calc(${header.heightXXl} + ${topBar.heightXXl})`,
};
...
const summoning = {
  ...
  headingOffsetTopMobile: "6rem",
  menuBreak: devices.lg,
  mobileBreak: devices.sm,
};
...
const gradients = {
  button: {
    ...
    secondary: `linear-gradient(to right, ${palette.green.dark} 0%, ${palette.green.semidark} 100%)`,
